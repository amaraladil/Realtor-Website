...
<!-- about section start -->
<section class="content-body" id='city'>
        <div class="max-width body-place">			
            <h2 class="title">Which City?</h2>
            <form action="<?php echo $_SERVER['PHP_SELF'];  ?>" method="post">
				<?php 
				
					//SELECT ALL OPTIONS			
					echo "\n<label><input type=\"checkbox\"  onclick=\"toggle(this);\" name=\"".$cities_table."[]\" value=\"0\" /><span>Select All</span></label>";					
